...
import { subscribeMailing } from '../actions/index';
...
class Footer extends Component {
  ...
  onSubmit(event) {
    const { subscribeMailing, addSnackbar } = this.props;
    event.preventDefault();
    subscribeMailing(event.target.value);
    addSnackbar(snackbarMessages.subscription[0]);
...
export default connect(null, { subscribeMailing, addSnackbar })(Footer);
